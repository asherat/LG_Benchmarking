...
unset title
set y2label 'SLAVE 1'
plot dir.'lg2'.file_city every::1 using 1:($2/4) with lines title "city", \
dir.'lg2'.file_town using 1:($2/4) with lines title "town", \
dir.'lg2'.file_desert using 1:($2/4) with lines title "desert"
### Last plot
# change only plot command here
currentplot = currentplot + 1.2
set tmargin at screen top(currentplot,n,h,t,b)
...
set y2label 'SLAVE 2'
plot dir.'lg3'.file_city every::1 using 1:($2/4) with lines title "city", \
dir.'lg3'.file_town using 1:($2/4) with lines title "town", \
dir.'lg3'.file_desert using 1:($2/4) with lines title "desert"
### Last (key) plot
